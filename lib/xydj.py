...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "1", "type_name": "阿布🌠剧场"},
                            {"type_id": "3", "type_name": "阿布🌠新剧"},
                            {"type_id": "2", "type_name": "阿布🌠热播"},
                            {"type_id": "7", "type_name": "阿布🌠星选"},
                            {"type_id": "5", "type_name": "阿布🌠阳光"}],
                  }
    ...
    def detailContent(self, ids):
        ...
        content = '阿布提醒您🎉短剧越看越上头哈哈哈📢' + data['data']['introduction']
